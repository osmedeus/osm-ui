...
import DeleteButton from '../containers/Details/Workspace/DeleteButton';
const {
  TableContainer,
  Table,
  TableHead,
    ...
    if (rawRows) {
      ...
      _.map(rawRows, function(item) {
        let row = {
          ...
          Delete: (
            <DeleteButton wsname={item.workspace} />
            ...
            <div className="bx--grid bx--grid--no-gutter bx--grid--full-width">
              <div className="bx--row landing-page__tab-content">
                <div className="bx--col-md-4 bx--col-lg-16">
                  <h1 className="landing-page__heading">Delete Workspace</h1>
                  <hr />
                </div>
                <div className="bx--col-md-4 bx--col-lg-16">
                  {payload_table}
