...
import SummaryTable from '../containers/Details/Workspace/SummaryTable';
...
class SummaryPage extends Component {
  ...
  render() {
    ...
    if (wsname != null) {
      table = <SummaryTable wsname={wsname} />;
    }
